package cn.skyjilygao.shardingsphere.config;
...
@Configuration
@Slf4j
public class PreciseSharingTableAlgorithmOfAlarmhis implements PreciseShardingAlgorithm<Date>, RangeShardingAlgorithm<Date> {
    @Autowired
    ...
    public String doSharding(Collection<String> availableTargetNames, PreciseShardingValue<Date> shardingValue) {
        ...
        log.info("执行操作的表名-1111111====={}",shardingValue.getLogicTableName() + dateformat.format(shardingValue.getValue()));
...
//    private static SimpleDateFormat dateformat = new SimpleDateFormat("yyyyMM");
    ...
    private static List<String> getRangeNameList(Date startTime, Date endTime) {
        ...
        while(!dd.getTime().after(endTime)) {
